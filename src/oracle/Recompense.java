...
public final class Recompense implements RecompenseInterface{
    ...
    public void echangerMiracleEtPunition(String oracle, String croyant) {
        ...
        System.out.println(oracle + " �change un miracle contre une punition avec le " + croyant);
    ...
    //grace a DP Singleton, une seule instance est lanc� alors
    //durant toute l'exection c le bois compteur qui est incr�ment�
